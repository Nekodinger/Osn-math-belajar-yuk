...
Buat repository baru di GitHub (boleh publik atau privat‑lalu‑publik‑pages).
Upload index.html dan app.js ke root repository tersebut (drag‑and‑drop
lewat web GitHub juga bisa, tidak perlu command line).
Buka Settings → Pages pada repo.
Pada Source, pilih branch main dan folder / (root), lalu Save.
Tunggu 1–2 menit, situs akan aktif di:
